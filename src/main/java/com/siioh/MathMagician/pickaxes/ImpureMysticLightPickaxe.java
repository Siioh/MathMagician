...
public class ImpureMysticLightPickaxe extends MathMagicianPickaxe {

	public ImpureMysticLightPickaxe() {
		super(MathMagicianPickaxe.mysticLight);
		setUnlocalizedName("impureMysticLightPickaxe");
		setTextureName("MathMagician:impureMysticLightPickaxe");
