...
public class MysticLightPickaxe extends MathMagicianPickaxe {

	boolean timeractive = false;

	public MysticLightPickaxe() {
		super(MathMagicianPickaxe.mysticLight);
		setUnlocalizedName("mysticLightPickaxe");
		setTextureName("MathMagician:mysticLightPickaxe");
