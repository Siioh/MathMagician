...
public class PureClumpOfLight extends MathMagicianItem {
	
	public PureClumpOfLight() {
		setUnlocalizedName("pureClumpOfLight");
		setTextureName("MathMagician:pureClumpOfLight");
