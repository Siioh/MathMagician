...
public class ImpureLightIngot extends MathMagicianItem {

	public ImpureLightIngot() {
		setUnlocalizedName("impureLightIngot");
		setTextureName("MathMagician:impureLightIngot");
