...
public class UpgradeCrystalLightChestplate extends LightUpgradeCrystal {
	
	public UpgradeCrystalLightChestplate() {
		setUnlocalizedName("upgradeCrystalLightChestplate");
	}
