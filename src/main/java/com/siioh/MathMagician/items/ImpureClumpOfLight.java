...
public class ImpureClumpOfLight extends MathMagicianItem {

	public ImpureClumpOfLight() {
		setUnlocalizedName("impureClumpOfLight");
		setTextureName("MathMagician:impureClumpOfLight");
