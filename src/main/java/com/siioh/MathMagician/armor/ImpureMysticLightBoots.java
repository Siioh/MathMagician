...
public class ImpureMysticLightBoots extends MathMagicianArmor {
	
	public ImpureMysticLightBoots() {
		super(MathMagicianArmor.mysticLight, 1, 3);
		setUnlocalizedName("impureMysticLightBoots");
		setTextureName("MathMagician:impureMysticLight_boots");
