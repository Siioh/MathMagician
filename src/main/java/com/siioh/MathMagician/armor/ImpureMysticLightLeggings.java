...
public class ImpureMysticLightLeggings extends MathMagicianArmor {

	public ImpureMysticLightLeggings() {
		super(MathMagicianArmor.mysticLight, 1, 2);
		setUnlocalizedName("impureMysticLightLeggings");
		setTextureName("MathMagician:impureMysticLight_leggings");
