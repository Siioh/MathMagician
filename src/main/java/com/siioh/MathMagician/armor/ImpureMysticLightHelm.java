...
public class ImpureMysticLightHelm extends MathMagicianArmor {

	public ImpureMysticLightHelm() {
		super(MathMagicianArmor.mysticLight, 1, 0);
		setUnlocalizedName("impureMysticLightHelm");
		setTextureName("MathMagician:impureMysticLight_helm");
